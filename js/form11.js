$(document).ready(function( ){
	...
	$('#send').click(function(){
		...
		if( ($('#cedula_atn').val().length > 0) && ($('#opr_area').val( ) == 'ar_11') )
		{
			$('form').submit( ).reset( );
		}
	...
	$( document ).on( "focus", "#real_11", function(e) {
        $('div#capa_one').css({
            display: 'block',
            position: 'absolute',
            top: '0px',
        ...
        $.post('consulta_interna.php', { area_real:'ar_11' }, function(data){
